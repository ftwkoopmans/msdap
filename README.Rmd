...
[Check this introduction to MS-DAP](doc/intro.md) for an overview of data visualizations (complete PDF reports are available at the bottom).



## Quickstart

Installation of the R package in brief, assuming R and RStudio have been installed (references for additional documentation @ next section)
