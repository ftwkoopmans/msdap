...
Note: the RT plots reveal an unexpected peak in peptide identifications at the end of the chromatogram. To rule out technical issues in data analysis, plotting MaxQuant output as-is corroborates the MS-DAP figures (we repeated the same procedure on a MetaMorpheus search of the same data to double-check).
