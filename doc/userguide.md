...
No particular settings are needed, MS-DAP can use the output as-is. The
.elib files generated by EncyclopeDIA for each input sample (mzML file)
are the input for MS-DAP.
