...
subtitle: 'version: beta 0.2.5  &nbsp; &nbsp;  https://github.com/ftwkoopmans/msdap/'
output:
  pdf_document:
    toc: true
    toc_depth: 2
...
if(length(l_contrast) > 0) {
  ...
  for(contr_index in seq_along(l_contrast)) {
    ...
    for(p in l_contrast[[contr_index]]$p_volcano_contrast) {
      subchunkify(print(p), unique_chunk_id = paste0("volcano_", contr_index, "_", i), fig_height = 8, fig_width = 7)
      cat('\n\n') 
      i = i + 1
    }
    ...
    subchunkify(print(l_contrast[[contr_index]]$p_foldchange_density), unique_chunk_id = paste0("foldchange_density_", contr_index), fig_height = 7, fig_width = 7)
    ...
    subchunkify(print(l_contrast[[contr_index]]$p_pvalue_hist), unique_chunk_id = paste0("pvalue_hist_", contr_index), fig_height = 7, fig_width = 7)
    ...
    if(exists("dd_plots") && contr %in% names(dd_plots)) {
      ...
      subchunkify(print(dd_plots[[contr_index]]), unique_chunk_id = paste0("dd_hist_", contr_index), fig_height = 4, fig_width = 4)
